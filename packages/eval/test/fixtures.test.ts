...
import { buildFixtures, allFixtures, quickFixtures, fixturesToHeadroomParams } from "../src/fixtures";
...
describe("fixtures: determinism", () => {
  ...
  test("cross-run determinism is pinned by a content digest", () => {
    ...
    expect(digest).toBe("1689828a6470811efbbc50b946f794ef0e434b1ade1ca6089a9c29d30b6ce746");
  });
});
...
describe("fixtures: structure and golden facts", () => {
  ...
  test("tool-output pool covers the brief's required variants", () => {
    ...
    for (const keyword of ["ls", "grep", "read", "diff", "test", "noise", "ansi", "carriage", "backspace"]) {
